								...
								<div class="form-group">
									<table class="table" id="dynamic_field">
										...
										<tr>
											...
											<td>
												<input type="number" name="ds[]" class="form-control form-control-line numb" min="0" max="1" step="0.05" size="30" placeholder="0 - 1">
...
<script>
	...
	$(document).ready(function(){
		...
		// 		'<tr id="row'+i+'"><td></td><td><select class="form-control form-control-line" name="id_gejala[]"><?php foreach($data2 as $dd){?>
